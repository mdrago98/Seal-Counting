...
def write_image(crop_function: Generator, directory: str) -> Iterator:
    ...
    :param crop_function: the crop function generator
    :param directory: the director to save in
    :return: the tuple of normalised coordinates and file name
    """
...
def process_image(image: Image, image_size: tuple, directory: str, n_process: int, seal_csv: str):
    cropped_image_loc = DataFrame({"tiff_file": [], "layer_name": [], "x_pixel": [], "y_pixel": []})
...
def generate_subset(images: list, image_size: tuple, locations: DataFrame, directory: str):
    image_records = []
...
if __name__ == "__main__":
    locations = read_excel(
        "/home/md273/CS5099-working-copy/data/pixel_coord.xlsx", sheet_name="PixelCoordinates",
